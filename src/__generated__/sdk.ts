    ...
    & { items?: Maybe<Array<Maybe<(
      ...
      & { product?: Maybe<(
        ...
        & { options?: Maybe<Array<Maybe<(
          { __typename?: 'SwellProductOption' }
          & Pick<SwellProductOption, 'id' | 'name'>
        )>>> }
      )> }
    )>>> }
  )> }
...
export type GetCategoryPreviewDataQuery = (
  { __typename?: 'Query' }
  & { categoryBySlug?: Maybe<(
    ...
    & { products?: Maybe<Array<Maybe<(
      { __typename?: 'SwellProduct' }
      & Pick<SwellProduct, 'id' | 'name' | 'slug' | 'price' | 'currency'>
    )>>>, images?: Maybe<Array<Maybe<(
      { __typename?: 'SwellCategoryImage' }
      & Pick<SwellCategoryImage, 'caption'>
      & { file?: Maybe<(
        { __typename?: 'SwellCategoryImageFile' }
        & Pick<SwellCategoryImageFile, 'url' | 'width' | 'height'>
      )> }
    )>>> }
  )> }
);
      ...
      & { categories?: Maybe<Array<Maybe<(
        ...
        & { standard?: Maybe<(
          ...
          & { plans?: Maybe<Array<Maybe<(
            { __typename?: 'SwellProductPurchaseOptionsSubscriptionPlan' }
            & Pick<SwellProductPurchaseOptionsSubscriptionPlan, 'id' | 'name' | 'price'>
            & { billingSchedule?: Maybe<(
              { __typename?: 'SwellProductPurchaseOptionsSubscriptionPlanBillingSchedule' }
              & Pick<SwellProductPurchaseOptionsSubscriptionPlanBillingSchedule, 'interval' | 'intervalCount'>
            )> }
          )>>> }
        )> }
      )>, variants?: Maybe<(
        ...
        & { results?: Maybe<Array<Maybe<(
          { __typename?: 'SwellProductVariant' }
          & Pick<SwellProductVariant, 'id' | 'name' | 'price' | 'origPrice' | 'optionValueIds' | 'stockLevel' | 'currency'>
...
export type GetProductsVariantsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProductsVariantsQuery = (
  { __typename?: 'Query' }
  & { products?: Maybe<(
    { __typename?: 'SwellProducts' }
    & { results?: Maybe<Array<Maybe<(
      { __typename?: 'SwellProduct' }
      & Pick<SwellProduct, 'id' | 'name' | 'slug'>
      & { variants?: Maybe<(
        { __typename?: 'SwellProductsVariants' }
        & { results?: Maybe<Array<Maybe<(
          { __typename?: 'SwellProductVariant' }
          & Pick<SwellProductVariant, 'name' | 'sku' | 'stockLevel' | 'currency'>
          & { prices?: Maybe<Array<Maybe<(
            { __typename?: 'SwellProductVariantPrice' }
            ...
            & { standard?: Maybe<(
              { __typename?: 'SwellProductVariantPurchaseOptionsStandard' }
              & Pick<SwellProductVariantPurchaseOptionsStandard, 'price' | 'sale' | 'salePrice'>
              & { prices?: Maybe<Array<Maybe<(
                { __typename?: 'SwellProductVariantPurchaseOptionsStandardPrice' }
                & Pick<SwellProductVariantPurchaseOptionsStandardPrice, 'price' | 'discountPercent'>
              )>>> }
            )> }
          )> }
        )>>> }
...
export type SearchProductsQuery = (
  ...
  & { products?: Maybe<(
    ...
    & { results?: Maybe<Array<Maybe<(
      { __typename?: 'SwellProduct' }
      & Pick<SwellProduct, 'id' | 'name' | 'currency' | 'slug' | 'price'>
    )>>> }
  )> }
);
...
export const GetCategoriesDocument = gql`
  ...
  categories {
    ...
    `;
export const GetCategoryPreviewDataDocument = gql`
    query getCategoryPreviewData($slug: String!) {
  categoryBySlug(slug: $slug, _locale: "es-MX") {
    name
    slug
    products {
      id
...
export const GetProductBySlugDocument = gql`
  ...
  productBySlug(slug: $slug) {
    ...
    `;
export const GetProductsVariantsDocument = gql`
...
const RemoveCartItemDocumentString = print(RemoveCartItemDocument);
const GetCategoriesDocumentString = print(GetCategoriesDocument);
const GetCategoryPreviewDataDocumentString = print(GetCategoryPreviewDataDocument);
...
const GetProductsVariantsDocumentString = print(GetProductsVariantsDocument);
const SearchProductsDocumentString = print(SearchProductsDocument);
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    removeCartItem(variables: RemoveCartItemMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: RemoveCartItemMutation; extensions?: any; headers: Dom.Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<RemoveCartItemMutation>(RemoveCartItemDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'removeCartItem', 'mutation');
    },
    ...
    getCategoryPreviewData(variables: GetCategoryPreviewDataQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetCategoryPreviewDataQuery; extensions?: any; headers: Dom.Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetCategoryPreviewDataQuery>(GetCategoryPreviewDataDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getCategoryPreviewData', 'query');
    },
    getAllProducts(variables?: GetAllProductsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetAllProductsQuery; extensions?: any; headers: Dom.Headers; status: number; }> {
    ...
    getProductBySlug(variables: GetProductBySlugQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetProductBySlugQuery; extensions?: any; headers: Dom.Headers; status: number; }> {
    ...
    getProductsVariants(variables?: GetProductsVariantsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetProductsVariantsQuery; extensions?: any; headers: Dom.Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetProductsVariantsQuery>(GetProductsVariantsDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getProductsVariants', 'query');
    },
    searchProducts(variables: SearchProductsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: SearchProductsQuery; extensions?: any; headers: Dom.Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<SearchProductsQuery>(SearchProductsDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'searchProducts', 'query');
    }
  };
}
